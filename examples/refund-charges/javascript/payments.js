...
*/
const Stripe = require('@interval/fake-stripe');
...
*/
module.exports.getCharges = async function getCharges(customerEmail) {
...
module.exports.refundCharge = async function refundCharge(id) {
...
module.exports.getRefunds = async function refundCharge(id) {
